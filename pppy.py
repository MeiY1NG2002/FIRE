...
class EDSR(nn.Module):
    def __init__(self, num_channels=1, num_features=64, num_residual_blocks=16, scale_factor=2):
...
# 6. 初始化模型并开始训练
model = EDSR(num_channels=1, num_features=64, num_residual_blocks=16, scale_factor=2)
